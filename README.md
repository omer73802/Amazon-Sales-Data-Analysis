...
## Business Objective
The objective of this project is to analyze Amazon sales data in order to
identify top-performing product categories, sales trends over time, and
key revenue drivers.
...
## Dataset Conclusions
-Seller-level analysis reveals two distinct sales patterns: some sellers achieve high average order values with relatively low total revenue, while others generate higher total revenue through larger transaction volumes despite lower average order values
